      ...
      {stats && (
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Score total</h3>
              <p className="text-3xl font-bold text-primary-600">{stats.total_score} points</p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Challenges résolus</h3>
              <p className="text-3xl font-bold text-primary-600">{stats.total_solved}</p>
            </div>
          </div>

          <div className="mt-8">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Par catégorie</h3>
          ...
          <div className="mt-8">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Par difficulté</h3>
